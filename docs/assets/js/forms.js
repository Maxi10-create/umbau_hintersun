...
(function () {
  ...
  var SCHEMAS = {
    ...
    cost_positions: { title: 'Kostenposition', fields: [
      ...
      { k: 'source_type', l: 'Herkunft', t: 'select', opt: ['manuell','Auftrag','Rechnung','Zahlung'], def: 'manuell', hint: 'Aufträge kommen automatisch aus Gewerke & Vergabe' },
      { k: 'date', l: 'Datum', t: 'date' },
      { k: 'net', l: 'Netto €', t: 'number' },
      { k: 'vat_rate', l: 'MwSt %', t: 'number', def: 22 },
      { k: 'gross', l: 'Brutto € (leer = auto)', t: 'number' },
      { k: 'paid_by', l: 'Bezahlt von', t: 'select', opt: OWNERS },
